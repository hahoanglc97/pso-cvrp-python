...
capacity_of_vehicle, total_customers, distance_matrix, demand_matrix, X, Y = readdata('A-n80-k10.vrp')
...
Iterations =int(input("Enter Number of generations for finding the fitness value on every iteration"))
